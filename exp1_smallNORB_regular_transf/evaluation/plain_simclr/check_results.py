...
if __name__ == "__main__":
    ...
    # print(model)
    chpt = torch.load("check_results_checkpoints/simclr_linear_evaluation_after_pretrained_ckpt_epoch_100.pth.tar", map_location="cuda") 
    model.load_state_dict(chpt["model_state"], strict=True)
